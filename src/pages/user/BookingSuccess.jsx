  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <main className="px-4 py-12 mx-auto max-w-4xl">
        ...
        <div className="p-8 mb-6 bg-white border border-gray-200 rounded-xl shadow-lg dark:bg-gray-800 dark:border-gray-700">
          ...
          {/* Flight Info */}
          <div className="p-6 mb-6 bg-gray-50 rounded-lg dark:bg-gray-700/50">
        ...
        <div className="flex flex-col gap-4 sm:flex-row">
          <button
            ...
            className="flex-1 flex items-center justify-center gap-2 px-6 py-3 text-white bg-blue-600 rounded-lg hover:bg-blue-700"
          >
          ...
          <button
            onClick={() => navigate('/')}
            className="flex-1 flex items-center justify-center gap-2 px-6 py-3 text-gray-700 bg-white border border-gray-300 rounded-lg dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700"
          >
